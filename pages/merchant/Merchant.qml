...
import byterubComponents.Subaddress 1.0
import byterubComponents.SubaddressModel 1.0
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    ByteRubComponents.TextPlain {
                        ...
                        font.bold: false
                        color: "white"
                        text: qsTr("Amount to receive") + " (BTR)" + translationManager.emptyString
                        themeTransition: false
                    }
                    ...
                    ByteRubComponents.TextPlain {
                        // @TODO: When we have BTR/USD rate avi. in the future.
                        visible: false
                        font.pixelSize: 14
                        font.bold: false
                        color: "white"
