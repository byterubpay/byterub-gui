...
begin
  ...
  RegQueryStringValue(HKEY_CURRENT_USER, 'Software\byterubpay\monero-core', 'blockchainDataDir', blockChainDir);
...
Root: HKCU; Subkey: "Software\byterubpay\monero-core"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\byterubpay\monero-core"; ValueType: string; ValueName: "blockchainDataDir"; ValueData: {code:BlockChainDirOrEmpty};
