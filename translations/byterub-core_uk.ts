...
<context>
    ...
    <message>
        ...
        <translation>Це полегшує надсилання та отримання ByteRub і знижує кількість помилок при введенні адрес вручну.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ПОПЕРЕДЖЕННЯ: Не використовуйте повторно свої ключі ByteRub в іншому форку, ЯКЩО ТІЛЬКИ цей форк не має вбудованих засобів захисту від компрометації введених ключів. Подібні дії можуть зашкодити вашій конфіденційності.</translation>
    </message>
    <message>
        ...
        <translation>УВАГА: Копіювання вашої мнемонічної фрази в буфер обміну може супроводжуватися перехопленням цих даних різним шкідливим програмним забезпеченням, яке відправить вашу мнемоніку зловмисникові, після чого ваші ByteRub можуть бути вкрадені. Будь ласка, введіть вашу мнемонічну фразу вручну з клавіатури.</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some ByteRub. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>Майнінг на вашому комп&apos;ютері допомагає зміцнити мережу ByteRub. Чим більше людей майнять, тим важче атакувати мережу, кожний може допомогти.

Майнінг також дає маленький шанс отримати ByteRub. Ваш комп&apos;ютер буде створювати хеші в пошуку вирішення блоку. Якщо ви знайдете блок, то получите винагороду! Щасти!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вбудована версія ByteRub: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Використовувати сторонній вузол для підключення до мережі ByteRub. Менш безпечно, але більш зручно.</translation>
    </message>
    <message>
        ...
        <translation>Щоб отримати список віддалених нод, введіть &apos;ByteRub remote node&apos; у вашій улюбленій пошуковій системі. Будь ласка, переконайтеся, що обраній ноді можна довіряти.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На цій сторінці можна взаємодіяти із загальною базою даних RingDB. Ця база даних призначена для використання гаманцями ByteRub або їх клонів, які зможуть повторно використовувати ключі ByteRub.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того щоб приховати які входи в транзакціях ByteRub були витрачені, третя сторона не повинна повідомляти які входи в кільці вже задіяні в витраті. Адже якщо це зробити, то це послабить захист, який забезпечується кільцевими підписами. Якщо відомо, що всі, крім одного з входів, вже витрачені, то фактично трата входу стає очевидною, тим самим анулюється ефект кільцевих підписів, одного з трьох основних рівнів захисту конфіденційності ByteRub.&lt;br&gt;Щоб допомогти транзакціям уникнути витрати цих входів, можна використовувати список відомих витрачених входів, щоб уникнути їх використання в нових транзакціях. Такий список підтримується проектом ByteRub і доступний на веб-сайті getbyterub.org, і ви можете імпортувати цей список тут.&lt;br&gt;Крім того, ви можете просканувати блокчейн (і блокчейни клонів ByteRub) самостійно, використовуючи інструмент byterub-blockchain-mark-spent-outputs, щоб створити список відомих витрачених входів.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Щоб уникнути скасування захисту, що забезпечується кільцевими підписами ByteRub, вихід не повинен проводитися з різними кільцями на різних блокчейнах. Хоча це як правило не викликає занепокоєння, він може стати одним, якщо якийсь клон ByteRub, що використовує ключ повторно, дозволяє вам витрачати існуючі виходи. В цьому випадку вам необхідно забезпечити, щоб ці існуючі виходи використовували одне і те ж кільце для обох блокчейнів.&lt;br&gt;Це може бути зроблено автоматично, або будь-яким програмним забезпеченням з можливістю повторного використання ключів, яке не спробує позбавити вас конфіденційності.&lt;br&gt;Якщо ви використовуєте клон ByteRub з повторним використанням ключа, і цей клон не включає цей захист, ви все одно можете гарантувати, що ваші транзакції будуть захищені, зробивши їх спочатку на клоні, потім вручну додати кільце на цій сторінці, що дозволить вам конфіденційно перевести ваші ByteRub.&lt;br&gt;Якщо ви не використовуєте клон ByteRub з повторним використанням ключів без цих функцій безпеки, то вам не потрібно нічого робити, оскільки все автоматизовано.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Тут записуються кільця, що використовуються виходами проведеними на ByteRub, так що одне і те ж кільце можна використовувати повторно, щоб уникнути проблем з конфіденційністю.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введіть адресу ByteRub (наприклад: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ByteRub відправлено успішно</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Щоб мати можливість обмінюватися даними з мережею ByteRub, ваш гаманець повинен бути підключений до ноди ByteRub. Для кращої конфіденційності рекомендується запустити свою власну ноду.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Окрім цього, ви можете вказати ноду швидкого завантаження, щоб негайно почати користуватися ByteRub.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вас вітає ByteRub.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Виберіть цю опцію, якщо ви вперше користуєтесь ByteRub.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Змінити мову графічного інтерфейсу ByteRub.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Тимчасове використання віддалених нод зручно для негайного використання ByteRub (звідси назва &quot;початкове завантаження&quot;), однак пам&apos;ятайте, що при використанні віддалених нод (включаючи вибір початкового завантаження), ноди можуть відстежувати вашу IP адресу, відстежувати вашу &quot;висоту відновлення&quot; і відповідні дані запиту блоку, і відправляти вам неточну інформацію, щоб дізнатися більше про здійснені вами транзакції.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Цей режим ідеально підходить для управління невеликими сумами ByteRub. У вас є доступ до основних функцій для здійснення транзакцій та управління ними. Програма автоматично підключиться до мережі ByteRub, щоб ви відразу могли почати використовувати ByteRub.</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Щоб мати можливість обмінюватися даними з мережею ByteRub, ваш гаманець повинен бути підключений до ноди ByteRub. Для кращої конфіденційності рекомендується запустити свою власну ноду.
...
може знадобитися ваша участь.</translation>
    ...
    <message>
        ...
        <translation>ByteRub успішно відправлені: %1 транзакция(й) </translation>
    </message>
    <message>
